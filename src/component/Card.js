...
console.log(stats.cases ?formatter.format(stats.cases):0)
             ...
             <Card className={classes.card} variant="outlined" elevation={3}>
                  <CardContent className={classes.cardContent}>
                    <CardMedia className={classes.cardMedia} align="center" >                    
                      ...
                      {stats.cases ?formatter.format(stats.cases):0}                
                      </Typography>
                    </CardMedia>
                  </CardContent>
                </Card>
                ...
                <Card className={classes.card} variant="outlined">
                  <CardContent className={classes.cardContent}>
                    <CardMedia className={classes.cardMedia} align="center" >                    
                      ...
                      <Divider/>
                      <Typography color="primary" style={{ fontSize: 40 }}>
                      {stats.deaths ?formatter.format(stats.deaths):0}  
                      </Typography>
                    </CardMedia>
                  </CardContent>
                </Card>
                ...
                <Card className={classes.card} variant="outlined">
                  <CardContent className={classes.cardContent}>
                    <CardMedia className={classes.cardMedia} align="center" >
                      ...
                      <Divider/>
                      <Typography color="primary" style={{ fontSize: 40 }}>
                      {stats.recovered ?formatter.format(stats.recovered):0}   
                      </Typography>
                    </CardMedia>
                  </CardContent>
                </Card>
                ...
                <Card className={classes.card} variant="outlined">
                  <CardContent className={classes.cardContent}>
                    <CardMedia className={classes.cardMedia} align="center" >
                      ...
                      <Divider/>
                      <Typography color="primary" style={{ fontSize: 40 }}>
                      {stats.tests ?formatter.format(stats.tests):0}   
                      </Typography>
                    </CardMedia>
                  </CardContent>
                </Card>
                <Card className={classes.card} variant="outlined">
                  <CardContent className={classes.cardContent}>
                    <CardMedia className={classes.cardMedia} align="center" >
                      ...
                      <Divider/>
                      <Typography color="primary" style={{ fontSize: 40 }}>
                      {stats.active ?formatter.format(stats.active):0}   
                      </Typography>
                    </CardMedia>
                  </CardContent>
                </Card>
                <Card className={classes.card} variant="outlined">
                  <CardContent className={classes.cardContent}>
                    <CardMedia className={classes.cardMedia} align="center" >
                      ...
                      {stats.affectedCountries ?formatter.format(stats.affectedCountries):0}   
                      </Typography>
                    </CardMedia>
                  </CardContent>
                </Card>
